...
async def _(event):
    ...
    packname = f"Adarsh T Sticker pack"
    packshortname = f"Adarsh_T{userid}"  # format: Uni_Borg_userid

    is_a_s = is_it_animated_sticker(reply_message)
    file_ext_ns_ion = "Adarsh_Sticker.png"
    ...
    if is_a_s:
        ...
        packname = f"Adarsh_AnimatedStickers"
        packshortname = f"Adarsh_Animated"  # format: Uni_Borg_userid
